...
// BUG BUG BUG: Sometimes an entity belongs in two different Octants,
// which currently will never occur because moving them to a lower octant
// removes them from the upper octant.
...
void MyOctant::RemoveChildEntities()
{
	for (int i = 0; i < m_childCount; i++) {
